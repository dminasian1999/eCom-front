            ...
            <form action="#" method="post">
              <div className="form-group">
                ...
                >
                  ...
                  <option value="Bouvet Island" data-provinces="[]">
                    Bouvet Island
                  </option>
                  <option
                  ...
                  <option value="Chile" data-provinces="[]">
                    Chile
                  </option>
                  ...
                  <option value="Costa Rica" data-provinces="[]">
                    Costa Rica
                  </option>
                  <option value="Croatia" data-provinces="[]">
                    Croatia
                  </option>
                  <option value="Cuba" data-provinces="[]">
                    Cuba
                  </option>
                  ...
                  <option value="Kuwait" data-provinces="[]">
                    Kuwait
                  </option>
                  ...
                  <option value="Macedonia, Republic Of" data-provinces="[]">
                    Macedonia
                  </option>
                  ...
                  <option value="Swaziland" data-provinces="[]">
                    Swaziland
                  </option>
                  ...
                  <option value="Syria" data-provinces="[]">
                    Syria
                  </option>
                  ...
                  <option value="Uruguay" data-provinces="[]">
                    Uruguay
                  </option>
                  ...
                  <option value="Venezuela" data-provinces="[]">
                    Venezuela
                  </option>
